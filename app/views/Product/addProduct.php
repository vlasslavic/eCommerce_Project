            ...
            <h4 class="mt-3 text-start ms-4">Preview:</h4>
                    <div  class="product col-9 mx-auto my-4">
                                    <div class="card  card-product-grid shadow" >
                                        <div class="img-wrap m-auto mt-3"> <img style="width: 100%; height: 17rem ; object-fit: cover;  overflow: hidden;"  id="preview_pic"  src="<?php echo ''.URLROOT.'public/'?><?php echo isset($data->picture)?'uploads/'.$data->picture:'img/blank.jpg'; ?>"> </div>
                                        <div class="info-wrap"> 
        ...
        <form enctype="multipart/form-data" method="POST" action="" role="presentation">
            ...
            <!-- <form class="_ab43" method="post" action=""> -->
                <div class="row justify-content-center align-items-center g-2  mt-2 mb-4">
                    ...
                    <div class="col-8 ms-5 ">
                        <input aria-required="true" required id="product_name" placeholder="Product Name" type="text"
                ...
                <div class="row justify-content-center align-items-center g-2  mt-2 mb-4">
                    ...
                    <div class="col-8 ms-5 ">
                        <input required aria-required="true"  step='0.01' min="0" id="sell_price"  placeholder="Sell Price" type="number"
                ...
                <div class="row justify-content-center align-items-center g-2  mt-2 mb-4">
                    ...
                    <div class="col-8 ms-5 ">
                        <input aria-required="false"  step='0.01' min="0" id="cost_price" placeholder="Cost Price" type="number"
                ...
                <div class="row justify-content-center align-items-center g-2  mt-2 mb-4">
                    ...
                    <div class="col-8 ms-5 ">
                        <input aria-required="true" required min="0" id="in_stock" placeholder="In Stock" type="number"
