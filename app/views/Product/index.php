...
<section class="py-5">
            ...
            <form method="POST" action="" role="AddToCart">
                <div class="row gx-4 gx-lg-5 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-1"><?php echo''.(isset($data->in_stock)?((($data->in_stock<10)?
                                                                                    ...
                                                                                    :'0').''; ?>  </div>
                            <div class="d-flex">
                                <input hidden name="product_id" id="product_id" value="<?php echo''.$data->product_id.'';?>">
                                <input required class="form-control text-center me-3" onchange="" name="inputQuantity" id="inputQuantity" type="number" value="1" min="1" max="<?php echo ''.(isset($data->in_stock)?($data->in_stock):0).'';?>" style="max-width: 4rem" />
                                <button name="action" value="AddToCart" type="submit" class="btn btn-outline-dark flex-shrink-0" >
                ...
                <div class="card  card-product-grid shadow" >
                    ...
                    <div class="bottom-wrap m-3 mx-4 d-flex align-items-center flex" style="height: 3em; overflow: hidden;">
                        <div class="price-wrap lh-sm text-start"> <strong class="price"> $'.(isset($related->sell_price)?$related->sell_price:'00.00').' </strong> <br>
                            ...
                            <a href="'.URLROOT.'Cart/addToCart/'.$related->product_id.'" class=" btn btn-warning float-end ms-auto btn-sm"> Add to cart</a>
                            <!-- price-wrap.// -->
                    </div> <!-- bottom-wrap.// -->
                </div> <!-- card // -->
                </a>
