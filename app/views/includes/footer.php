...
<footer class="" >
    <div class=" my-4 d-flex justify-content-center">
            <div class="d-flex mt-1">© 2022<span class="fw-bold ms-1 ">myRide</span> <span class='ms-1'> team</span>  <a target="_blank" href="https://github.com/vlasslavic/eCommerce_Project" class="fw-normal ms-1 text-black">BootstrapFTW</a>
            </div>
            <?php echo'
            <ul class="nav nav-pills nav-fill  col-md-auto mb-2 mt-n5 fs-6 align-top mb-md-0 text-decoration-none">
                <li class="nav-item dropdown  ">
                <a class=" nav-link dropdown-toggle text-decoration-none text-black fs-6 fw-bold" data-bs-toggle="dropdown"  role="button" aria-expanded="false"><i class="bi bi-globe2"></i><a/>
