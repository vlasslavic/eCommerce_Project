...
<h1 class="text-center fs-3 fw-bold mb-4" >Select an account type:</h1>
    <div class=" d-flex justify-content-center align-items-center pt-4" >
            <a href="<?php echo''.URLROOT.''?>User/registerCustomer" class="text-decoration-none text-dark">
            ...
            <a href="<?php echo''.URLROOT.''?>User/registerSeller" class="text-decoration-none text-dark">
                <div class="card mx-5 shadow" style="width: 19rem; height: 400px;" >
